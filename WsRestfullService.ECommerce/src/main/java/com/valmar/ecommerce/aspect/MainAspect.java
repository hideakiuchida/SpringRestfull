...
public class MainAspect {
	...
	/*@Before("execution(* com.valmar.ecommerce.model.*.get*())")
    ...
    @Pointcut("within(com.valmar.ecommerce.controller.*)")
    public void allMethodsPointcut(){}
    
    
    @Before("execution(public void com.valmar.ecommerce.controller.AuthenticationRestController.createAuthenticationToken())")
